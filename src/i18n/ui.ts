...
const en: UIStrings = {
  ...
  'footer.copyright': '© 2026 VectoJS. Built with Astro and VectoJS.',
  'lang.label': 'Language',
...
const zhCN: UIStrings = {
  ...
  'footer.copyright': '© 2026 VectoJS。使用 Astro 与 VectoJS 构建。',
  'lang.label': '语言',
  'lang.switcher': '选择语言',
...
const zhTW: UIStrings = {
  ...
  'footer.copyright': '© 2026 VectoJS。以 Astro 與 VectoJS 建置。',
  'lang.label': '語言',
  'lang.switcher': '選擇語言',
...
const ja: UIStrings = {
  ...
  'footer.copyright': '© 2026 VectoJS. Astro と VectoJS で構築。',
  'lang.label': '言語',
  'lang.switcher': '言語を選択',
...
const fr: UIStrings = {
  ...
  'footer.copyright': '© 2026 VectoJS. Conçu avec Astro et VectoJS.',
  'lang.label': 'Langue',
...
const es: UIStrings = {
  ...
  'footer.copyright': '© 2026 VectoJS. Creado con Astro y VectoJS.',
  'lang.label': 'Idioma',
...
const ko: UIStrings = {
  ...
  'footer.copyright': '© 2026 VectoJS. Astro와 VectoJS로 제작.',
  'lang.label': '언어',
  'lang.switcher': '언어 선택',
