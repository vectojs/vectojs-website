...
> 文件版本：**1.9.5**。事實來源：`dist/index.d.ts`（公開表面）和 `packages/ui/src/*`（行為）。
...
<figure class="sandbox component-gallery">
  <div class="sandbox-bar"><span class="dot"></span><span class="dot"></span><span class="dot"></span><span class="sandbox-label">live · @vectojs/ui 1.9.5 · 內部可捲動</span></div>
