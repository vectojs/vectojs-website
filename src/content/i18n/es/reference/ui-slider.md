...
<figure class="sandbox component-demo">
  ...
  <iframe src="/sandbox/ui/slider.html?v=core-1.9.2-ui-1.9.3" class="sandbox-frame component-demo-frame component-demo-frame-tall" loading="eager" title="Demostración en vivo de Slider" sandbox="allow-scripts allow-same-origin"></iframe>
