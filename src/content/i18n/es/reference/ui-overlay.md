...
<figure class="sandbox component-demo">
  ...
  <iframe src="/sandbox/ui/overlay.html?v=core-1.16.3-ui-2.2.0" class="sandbox-frame component-demo-frame component-demo-frame-tall" loading="eager" title="Demostración en vivo de Overlay" sandbox="allow-scripts allow-same-origin"></iframe>
