...
<figure class="sandbox component-demo">
  ...
  <iframe src="/sandbox/ui/button.html?v=core-1.9.2-ui-1.10.0" class="sandbox-frame component-demo-frame" loading="eager" title="Démonstration live du bouton" sandbox="allow-scripts allow-same-origin"></iframe>
