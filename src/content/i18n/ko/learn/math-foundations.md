...
- _결과_: 쿼리 시간은 겹친 셀 수 + 반환된 ID에 비례합니다. 작고 비슷한 크기이며 균일하게 분포된 엔티티에 대해서만 거의 상수에 가깝고, 밀집된 버킷은 선형 스캔으로 성능이 저하됩니다. [성능 가이드](/learn/performance/#3-sea-of-entities-interaction-on2-complexity-catastrophe)를 참조하세요.
