...
<figure class="sandbox component-demo">
  ...
  <iframe src="/sandbox/ui/overlay.html?v=core-1.17.0-ui-2.2.0" class="sandbox-frame component-demo-frame component-demo-frame-tall" loading="eager" title="Overlay 라이브 데모" sandbox="allow-scripts allow-same-origin"></iframe>
