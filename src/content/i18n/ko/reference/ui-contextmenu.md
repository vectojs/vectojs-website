...
<figure class="sandbox component-demo">
  ...
  <iframe src="/sandbox/ui/component.html?name=contextmenu&v=core-1.17.0-ui-2.2.0" class="sandbox-frame component-demo-frame-tall" loading="eager" title="ContextMenu 라이브 데모" sandbox="allow-scripts allow-same-origin allow-popups"></iframe>
...
핫스팟은 `pointerEvents: 'none'`을 설정하므로 메뉴는 자체적인 위치 기반 `pointerdown` 히트 처리를 유지합니다. [복합 위젯](/reference/core-a11y/#composite-widgets-roving-tabindex)을 참조하세요.
