...
<figure class="sandbox component-demo">
  ...
  <iframe src="/sandbox/ui/component.html?name=card&v=core-1.31.0-ui-2.13.0" class="sandbox-frame component-demo-frame-tall" loading="eager" title="Card 라이브 데모" sandbox="allow-scripts allow-same-origin allow-popups"></iframe>
