...
<figure class="sandbox component-demo">
  ...
  <iframe src="/sandbox/ui/component.html?name=resizablepanel&v=core-1.32.2-ui-2.13.1" class="sandbox-frame component-demo-frame-tall" loading="eager" title="크기 조절 가능한 패널 라이브 데모" sandbox="allow-scripts allow-same-origin allow-popups"></iframe>
