...
<figure class="sandbox component-demo">
  ...
  <iframe src="/sandbox/ui/component.html?name=tabs&v=core-1.15.0-ui-2.0.0" class="sandbox-frame component-demo-frame-tall" loading="eager" title="Tabs 라이브 데모" sandbox="allow-scripts allow-same-origin allow-popups"></iframe>
