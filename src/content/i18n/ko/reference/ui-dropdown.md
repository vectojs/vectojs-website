...
<figure class="sandbox component-demo">
  ...
  <iframe src="/sandbox/ui/component.html?name=dropdown&v=core-1.9.2-ui-1.9.5" class="sandbox-frame component-demo-frame-tall" loading="eager" title="Dropdown 라이브 데모" sandbox="allow-scripts allow-same-origin allow-popups"></iframe>
