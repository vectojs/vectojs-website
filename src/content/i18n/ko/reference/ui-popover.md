...
<figure class="sandbox component-demo">
  ...
  <iframe src="/sandbox/ui/component.html?name=popover&v=core-1.17.1-ui-2.3.0" class="sandbox-frame component-demo-frame-tall" loading="eager" title="Popover 라이브 데모" sandbox="allow-scripts allow-same-origin allow-popups"></iframe>
