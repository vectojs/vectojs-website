...
<figure class="sandbox component-demo">
  ...
  <iframe src="/sandbox/ui/component.html?name=checkbox&v=core-1.25.0-ui-2.6.0" class="sandbox-frame component-demo-frame-tall" loading="eager" title="Checkbox 라이브 데모" sandbox="allow-scripts allow-same-origin allow-popups"></iframe>
