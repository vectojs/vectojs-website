...
> Version documented: **1.8.0**. Source of truth: `dist/index.d.ts` (public surface) and `packages/ui/src/*` (behavior).
...
<figure class="sandbox component-gallery">
  <div class="sandbox-bar"><span class="dot"></span><span class="dot"></span><span class="dot"></span><span class="sandbox-label">live · @vectojs/ui 1.8.0 · scroll inside</span></div>
