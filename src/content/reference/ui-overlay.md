...
<figure class="sandbox component-demo">
  ...
  <iframe src="/sandbox/ui/overlay.html" class="sandbox-frame component-demo-frame component-demo-frame-tall" loading="eager" title="Overlay live demo" sandbox="allow-scripts allow-same-origin"></iframe>
