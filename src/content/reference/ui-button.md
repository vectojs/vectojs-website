...
<figure class="sandbox component-demo">
  ...
  <iframe src="/sandbox/ui/button.html?v=core-1.9.2-ui-1.9.3" class="sandbox-frame component-demo-frame" loading="eager" title="Button live demo" sandbox="allow-scripts allow-same-origin"></iframe>
