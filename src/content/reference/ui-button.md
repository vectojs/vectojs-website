...
<figure class="sandbox component-demo">
  ...
  <iframe src="/sandbox/ui/button.html?v=ui-bundle-1" class="sandbox-frame component-demo-frame" loading="eager" title="Button live demo" sandbox="allow-scripts allow-same-origin"></iframe>
