...
<figure class="sandbox component-demo">
  ...
  <iframe src="/sandbox/ui/overlay.html?v=core-1.39.0-ui-2.20.1" class="sandbox-frame component-demo-frame component-demo-frame-tall" loading="eager" title="Overlay live demo" sandbox="allow-scripts allow-same-origin"></iframe>
...
| `Overlay`     | 手动 `showAt()` / `showAtPoint(x, y, source?)` | 自定义浮动组件         |
