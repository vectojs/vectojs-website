...
<figure class="sandbox component-demo">
  ...
  <iframe src="/sandbox/ui/button.html?v=core-1.39.0-ui-2.20.1" class="sandbox-frame component-demo-frame" loading="eager" title="Demostración en vivo de Button" sandbox="allow-scripts allow-same-origin"></iframe>
