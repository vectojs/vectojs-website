...
<figure class="sandbox component-demo">
  ...
  <iframe src="/sandbox/ui/component.html?name=treeview&v=core-1.39.0-ui-2.20.1" class="sandbox-frame component-demo-frame-tall" loading="eager" title="TreeView 라이브 데모" sandbox="allow-scripts allow-same-origin allow-popups"></iframe>
...
핫스팟은 `pointerEvents: 'none'`을 설정하므로 트리는 자체 마우스 처리(탭으로 토글, 드래그로 스크롤)를 유지합니다—키보드 포커스와 AT 합성 `click`은 여전히 통과합니다. [복합 위젯](/reference/core-a11y/#boghab-wijes-robing-tabindex)을 참조하세요.
