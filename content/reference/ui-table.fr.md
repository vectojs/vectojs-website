...
<figure class="sandbox component-demo">
  ...
  <iframe src="/sandbox/ui/component.html?name=table&v=core-1.39.0-ui-2.20.1" class="sandbox-frame component-demo-frame-tall" loading="eager" title="Démonstration live de Table" sandbox="allow-scripts allow-same-origin allow-popups"></iframe>
...
La cellule cible est défilée en vue avant que le focus ne se déplace vers elle. Voir [Widgets composites](/reference/core-a11y/#widgets-composes-tabindex-flottant).
