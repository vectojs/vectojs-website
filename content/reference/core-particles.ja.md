...
`particleData: Float32Array`、長さは `maxParticles × PARTICLE*STRIDE*FLOATS`（`PARTICLE*STRIDE*FLOATS = 8`）。パーティクルごとに8つの浮動小数点数：
