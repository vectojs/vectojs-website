...
<figure class="sandbox component-demo">
  ...
  <iframe src="/sandbox/ui/component.html?name=radiogroup&v=core-1.39.0-ui-2.20.1" class="sandbox-frame component-demo-frame-tall" loading="eager" title="RadioGroup 라이브 데모" sandbox="allow-scripts allow-same-origin allow-popups"></iframe>
