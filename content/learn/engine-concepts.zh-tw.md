...
- 理論：[數學基礎：VMT](/learn/math-foundations/#1-虛擬數學樹-vmt)
...
- 理論：[數學基礎：a11yRoot](/learn/math-foundations/#2-語意陰影-dom-a11yroot)
...
- 理論：[數學基礎：仿射變換](/learn/math-foundations/#3-仿射變換)

## 4. 冷/熱布局

文字布局將昂貴的內容準備與響應式換行分開。內容變化走冷路徑；寬度變化可以重用已準備好的測量結果。

- 理論：[數學基礎：冷/熱分離](/learn/math-foundations/#4-冷熱分離布局引擎)
...
- 理論：[數學基礎：集合差代數](/learn/math-foundations/#5-文字流的集合差代數)

## 6. 取樣樣條命中測試

`SplineEntity` 將曲線取樣為快取的線段，並比較指標與這些線段的平方距離。這避免了像素讀取，並且比僅使用 AABB 的命中測試更精確。

- 理論：[數學基礎：取樣樣條命中測試](/learn/math-foundations/#6-取樣樣條命中測試)

## 7. 半隱式尤拉動力學

中斷的 UI 過渡被建模為彈簧系統，而非一次性 CSS 計時器。目標可以在運動途中改變，而運動保持連續。

- 理論：[數學基礎：ODE 動力學](/learn/math-foundations/#7-微分方程式與半隱式尤拉求解器)
...
- 理論：[數學基礎：SpatialHashGrid 工具](/learn/math-foundations/#8-spatialhashgrid-工具)
